...
<main class="main">
    ...
    <section id="accueil" class="hero">
        <div class="hero-content">
            ...
            <p>Votre distributeur de confiance pour boissons, eaux, sodas, bières et gaz domestique. Vente en gros et détail avec service de livraison rapide dans toute la région.</p>
        ...
        <div class="container">
            ...
            <div class="about-content">
                <div class="about-text">
                    ...
                    <p>Depuis plus de 10 ans, SAGER s'est imposé comme le leader de la distribution de boissons et de gaz domestique dans la région. Notre engagement envers la qualité et le service client nous a permis de bâtir une réputation solide.</p>
                    
                    <h3>Notre Mission</h3>
                    <p>Fournir à nos clients des produits de qualité supérieure à des prix compétitifs, avec un service de livraison rapide et fiable. Nous nous efforçons de répondre aux besoins de nos clients particuliers et professionnels.</p>
                </div>
            ...
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <p>Service de livraison dans toute la région avec des délais respectés et un service client de qualité.</p>
                </div>
                <div class="feature-card">
                    <i class="fas fa-shield-alt"></i>
                    <h3>Produits de Qualité</h3>
                    <p>Nous sélectionnons rigoureusement nos fournisseurs pour garantir la fraîcheur et la qualité de nos produits.</p>
                </div>
                <div class="feature-card">
                    <i class="fas fa-users"></i>
                    <h3>Service Client</h3>
                    <p>Une équipe dédiée à votre service pour répondre à toutes vos questions et besoins spécifiques.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="produits" class="gallery">
        <div class="container">
            ...
            <div class="gallery-grid">
                ...
                <div class="gallery-item">
                    <div style="height: 250px; background: linear-gradient(45deg, #667eea, #764ba2); display: flex; align-items: center; justify-content: center; color: white; font-size: 3rem;">
                ...
                <div class="contact-info">
                    ...
                    <div class="contact-item">
                        ...
                        <div>
                            ...
                            contact@sager-distribution.com<br>
                            commandes@sager-distribution.com
                        </div>
                    </div>
