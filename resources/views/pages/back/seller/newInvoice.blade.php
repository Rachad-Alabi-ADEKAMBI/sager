...
<body>
    ...
    <div class="invoice" id="invoice">
        ...
        <h4>FACTURE / N° {{ $sale->id }}/{{ now()->format('m') }}/{{ now()->format('y') }}/FR-N</h4>

        <p><strong>Agence:</strong> AKPAKPA | BOUTIQUE SAGER<br>
        ...
        <p><strong>Situation des emballages</strong><br>
            DETAILS: UNITÉ 0 / RST: 0</p>
        ...
        <div class="footer">
            ...
            <p style="text-align:center; font-size: 12px;">
                {{ $sale->seller_name }} — {{ $sale->created_at->format('d/m/Y') }} —
    ...
    <script>
        ...
        async function downloadPDF() {
            ...
            await doc.html(invoice, {
                callback: function(doc) {
                    doc.save('facture.pdf');
                },
                x: 10,
                y: 10,
                width: 180, // largeur max dans la page PDF
                windowWidth: invoice.scrollWidth, // largeur du contenu HTML
            });
        }
